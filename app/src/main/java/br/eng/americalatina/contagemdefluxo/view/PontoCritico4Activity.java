...
public class PontoCritico4Activity extends AppCompatActivity {
    private SharedPreferences preferences;
    PontoCritico pontoCritico;
    public Veiculo veiculo;

    PontoCritico4Controller controller;
    int lastId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ponto_critico4);
    ...
    private void initFormulario() {
        ...
        controller = new PontoCritico4Controller(getApplicationContext());
    ...
    private void goToChooseCar() {
        ...
        Intent intent =
                new Intent(PontoCritico4Activity.this, QualVeiculoActivity.class);
    ...
    private void exitButton() {
        ...
        btn02.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                veiculo.setSaida("Sentido Marataízes");
                goToChooseCar();
            }
        });
        btn03.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                veiculo.setSaida("Sentido Marobá");
                goToChooseCar();
            }
        });
    }
    ...
    private void buttonWait(Button btnGeneric) {
        ...
        if (btnGeneric == btn02) {
            veiculo.setEntrada("Sentido Marataízes");
            veiculo.setData(AppUtil.getDataAtual());
            veiculo.setHora(AppUtil.getHoraAtual());
            exitButton();
        }
        if (btnGeneric == btn03) {
            veiculo.setEntrada("Sentido Marobá");
            veiculo.setData(AppUtil.getDataAtual());
            veiculo.setHora(AppUtil.getHoraAtual());
            exitButton();
        }
    ...
    private void deleteLast() {
        new AndExAlertDialog.Builder(PontoCritico4Activity.this)
                .setTitle("DELETAR")
